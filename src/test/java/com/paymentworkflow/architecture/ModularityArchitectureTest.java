package com.paymentworkflow.architecture;
 ...
 */
@AnalyzeClasses(packages = "com.paymentworkflow", importOptions = ImportOption.DoNotIncludeTests.class)
class ModularityArchitectureTest {

    @ArchTest
    static final ArchRule top_level_modules_should_be_free_of_cycles =
            slices()
                    .matching("com.paymentworkflow.(*)..")
